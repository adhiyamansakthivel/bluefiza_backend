              ...
              <form wire:submit.prevent="categoryName">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" id="exampleSelectRounded0" wire:model="naviname">
                        <option value="0" default>select Naviation</option>
                  ...
                  <div class="form-group">
                    <label>color</label>
                    <input type="color" class="form-control" wire:model="catbgc" >
                    <span style="background-color:{{$catbgc}};color:white">{{$catbgc}}</span><br/>
                    <span style="color:{{$catbgc}};">{{$catbgc}}</span>
                  </div>
                  <div class="form-group">
        ...
        <div class="card-body">
          ...
          <table  class="table table-bordered">
                          ...
                          <tr>
                            ...
                            <td><span style="background-color:{{$categoryValue->blc_color}};color:white">{{$categoryValue->blc_color}}</span></td>
                            <td><span style="color:{{$categoryValue->blc_color}};">{{$categoryValue->blc_color}}</span></td>
                            <td><p>Add Post</p></td>
                            <td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
             ...
             <div class="card-body">
                ...
                <hr>
                <strong>Color</strong>
                <p class="text-muted">Background: <span style="background-color:{{$modelValView->blc_color}};color:white">{{$modelValView->blc_color}}</span></p>
                <p class="text-muted">Font: <span style="color:{{$modelValView->blc_color}};">{{$modelValView->blc_color}}</span></p>
                <hr>
             ...
             <form wire:submit.prevent="editCategoryName('{{$modelaValue}}')">
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    {{$edit_navigation->bln_key}}
                </div>
                <div class="form-group">
                  <label>color</label>
                  <input type="color" class="form-control" wire:model="edit_catbgc" >
                  <span style="background-color:{{$edit_catbgc}};color:white">{{$edit_catbgc}}</span><br/>
                  <span style="color:{{$edit_catbgc}};">{{$edit_catbgc}}</span>
                </div>
                <div class="form-group">
                    <label>Meta Title</label>
